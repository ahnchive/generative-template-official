...
def draw_heatmap(gazepoints, dispsize, imagefile=None, alpha=0.5, savefilename=None, gaussianwh=200, gaussiansd=None, title=None, bbox=None):
    """Draws a heatmap of the provided fixations, optionally drawn over an
    image, and optionally allocating more weight to fixations with a higher
    duration.
    arguments
    gazepoints		-	a list of gazepoint tuples (x, y) in image coordinate
...
#         plt.title(title, fontsize=20)
    ...
    if bbox:
        box_plot = Rectangle((bbox[0], bbox[1]), bbox[2], bbox[3], fill=False, edgecolor='blue', linewidth=10)
